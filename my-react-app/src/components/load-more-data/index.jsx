...
export default function LoadMoreData() {
    ...
    return <div className="load-more-container">
        ...
        <div>
            <button disabled={disableButton} onClick={() => setCount(count + 1)} className="button-container">Load More Data</button>
            {
                disableButton ? <p>You have reached the end of the webpage</p>:null
            }
        </div>
    </div>
}